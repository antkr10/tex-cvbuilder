...
% Define the desired theme out of the following: beige, blue, bw, gray, minimal
...
\profilepic{dummy_pp.jpg} % Profile picture (supported only with "bw" and "gray" themes)
...
\switchcolumn[1] % This command is used to switch to the right column (document body)
